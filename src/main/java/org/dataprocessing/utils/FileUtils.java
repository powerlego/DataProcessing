...
public class FileUtils extends Utils {
    ...
    public void writeCSV(Path filename, List<List<String>> table) {
        try {
            ...
            List<String[]> convertedTable = converters.convertTableToTableArray(table);
        ...
        protected Void call() {
            ...
            if (!isCancelled()) {
                ...
                if (!isCancelled()) {
                    ...
                    AreaReference reference = new AreaReference(new CellReference(0, 0), new CellReference(table.size() - 1, tableHeaderRow.size() - 1), SpreadsheetVersion.EXCEL2007);
